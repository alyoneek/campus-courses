            ...
            >
              <g id="s0">
                ...
                >
                  ...
                  <g id="Group-7" transform="translate(0.000000, 265.000000)">
                    ...
                    <TweenOne
                      component="g"
                      animation={{ ...animate.y, delay: 1050 }}
                    >
                      <rect
                    ...
                    <TweenOne
                      component="g"
                      animation={{ ...animate.y, delay: 1000 }}
                    >
                      <rect
              ...
              <g id="s2">
                <g id="Group-18" transform="translate(19.000000, 57.000000)">
                  ...
                  <TweenOne
                    component="g"
                    animation={{ ...animate.x2, x: -5, delay: 450 }}
                  >
                    <rect
                  ...
                  <TweenOne
                    component="g"
                    animation={{ ...animate.x2, x: -5, delay: 470 }}
                  >
                    <rect
                  ...
                  <TweenOne
                    component="g"
                    animation={{ ...animate.x2, x: -5, delay: 460 }}
                  >
                    <rect
                  ...
                  <TweenOne
                    component="g"
                    animation={{ ...animate.x2, x: -5, delay: 480 }}
                  >
                    <rect
                  ...
                  >
                    <TweenOne
                      component="g"
                      animation={{ ...animate.y2, delay: 340 }}
                    >
                  ...
                  <TweenOne
                    component="g"
                    animation={{ ...animate.alpha, y: 5, delay: 600 }}
                  >
                    <rect
                  ...
                  <TweenOne
                    component="g"
                    animation={{ ...animate.scale, delay: 450 }}
                  >
                    <ellipse
                      id="Oval-3"
                      fill="#06080A"
              ...
              <g id="s7">
                <g id="Group-12" transform="translate(256.000000, 113.000000)">
                  <g id="Group-14" transform="translate(0.856649, 0.291066)">
                    <TweenOne
                      component="g"
                      animation={{ ...animate.x2, delay: 500 }}
                    >
                    ...
                    <TweenOne
                      component="g"
                      animation={{ ...animate.x2, delay: 550 }}
                    >
                      <use
                    ...
                    <TweenOne
                      component="g"
                      animation={{ ...animate.x2, delay: 600 }}
                    >
                  ...
                  <TweenOne
                    component="g"
                    animation={{ ...animate.scale, delay: 650 }}
                  >
                    <ellipse
                      id="Oval-3-Copy-4"
                      fill="#06080A"
              ...
              <g id="s9">
                <g id="Group-22" transform="translate(399.000000, 91.000000)">
                  <TweenOne
                    component="g"
                    animation={{ ...animate.x2, delay: 650 }}
                  >
                    <polygon
                  ...
                  <TweenOne
                    component="g"
                    animation={{ ...animate.x2, delay: 680 }}
                  >
                    <rect
                      id="Rectangle-17-Copy-7"
                      fill="#40A9FF"
                  ...
                  <TweenOne
                    component="g"
                    animation={{ ...animate.x2, delay: 700 }}
                  >
                    <rect
                      id="Rectangle-17-Copy-7"
                      fill="#2F54EB"
                  ...
                  <TweenOne
                    component="g"
                    animation={{ ...animate.x2, delay: 720 }}
                  >
                    <rect
                      id="Rectangle-17-Copy-7"
                      fill="#FADB14"
                  ...
                  <TweenOne
                    component="g"
                    animation={{ ...animate.alpha, delay: 1000 }}
                  >
                    <path
              ...
              <g id="s11">
                <g id="Group-11" transform="translate(55.000000, 28.000000)">
                  ...
                  <TweenOne
                    component="g"
                    animation={{ ...animate.scale, delay: 100 }}
                  >
                    <ellipse
                      id="Oval-8-Copy-3"
                      fill="#FA541C"
              ...
              <g id="s13">
                <g id="Group-6" transform="translate(386.000000, 176.000000)">
                  <TweenOne
                    component="g"
                    animation={{ ...animate.alpha, y: 10, delay: 600 }}
                  >
                    <ellipse
                      id="Oval-3-Copy-4"
                      fill="#06080A"
                  ...
                  <TweenOne
                    component="g"
                    animation={{ ...animate.alpha, y: 10, delay: 700 }}
                  >
                    <rect
                      id="Rectangle-17-Copy-11"
                      fill="url(#linearGradient-24)"
